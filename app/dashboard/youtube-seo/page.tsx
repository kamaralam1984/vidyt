          ...
          >
            <div className="bg-[#181818] border border-[#212121] rounded-xl p-6">
                ...
                {(['video', 'short', 'live'] as const).map((type) => (
                  <button
                    ...
                    className={`flex-1 py-2 px-3 rounded-md text-sm font-medium transition ${
                      contentType === type ? 'bg-[#FF0000] text-white' : 'text-[#AAA] hover:text-white hover:bg-[#333]'
                    }`}
                  >
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm text-[#AAAAAA] mb-1">Keywords / Tags (comma or newline)</label>
                  <textarea
                    value={keywords}
                      ...
                      {channelSummary.homepageKeywords!.map((item, i) => (
                        <span
                          ...
                          className={`px-2 py-1 rounded text-sm font-medium border ${
                            item.score >= 70 ? 'bg-emerald-500/20 text-emerald-400 border-emerald-500/40' : item.score >= 40 ? 'bg-amber-500/20 text-amber-400 border-amber-500/40' : 'bg-red-500/20 text-red-400 border-red-500/40'
                          }`}
                        >
